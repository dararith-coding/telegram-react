...
class Caption extends React.Component {
    ...
    loadData = async () => {
        ...
        try {
            ...
            const requests = [
                fetch('telegram-react/data/TwoFactorSetupMonkeyClose.json'),
                fetch('telegram-react/data/TwoFactorSetupMonkeyIdle.json'),
                fetch('telegram-react/data/TwoFactorSetupMonkeyPeek.json'),
                fetch('telegram-react/data/TwoFactorSetupMonkeyTracking.json')
            ];

            const results = await Promise.all(requests);
            // const [closeData, idleData, peekData, trackingData] = await Promise.all(results.map(x => {
            //     console.log('x:',x)
            //     return x.json();
            // }));
